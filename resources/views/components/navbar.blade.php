...
<header id="home" class="site-header">
    ...
    <div class="container header-main">
        <a href="{{ route('home') }}" aria-label="Selva Electricals home"><img class="logo" src="{{ asset('images/figma/7ce94.png') }}" alt="Selva Electricals" width="48" height="48"></a>
        ...
        <div class="header-actions">
            ...
            <button class="account-button" data-open="account" aria-label="Trade account information"><x-store-icon file="59e02.svg" :size="16" /></button>
        </div>
    </div>
